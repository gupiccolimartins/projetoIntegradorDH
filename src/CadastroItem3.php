...
<head>
    ...
    <link href="./css/CadItemMod.css" rel="stylesheet" type="text/css" />
            ...
            <h1><small>clique na imagem para iniciar</small></h1>
                <div class="avatar-upload">
                        ...
                        <div class="avatar-preview">
                            <div id="imagePreview" style="background-image: url(img/pesca.png);">
                            </div>
                        </div>
                </div>
        </div>
...
//# sourceURL=pen.js
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="md-form mb-0">
                        <textarea type="text" id="message" name="message" rows="12" class="form-control md-textarea"></textarea>
...
<div class="container">
    <div class="row">
        <div class="col">  
            <article class="article_items">
                <a href="#">
                <img src="img/furadeira.png" alt="item" title="item" />
                </a>
            <p>Furadeira</p></div>
        <div class="col">        
            <article class="article_items">
                <a href="#">
                <img src="img/muffin.png" alt="item" title="item" />
                </a>
            <p>Muffin</p></div>
    </div>
    <div class="row">
        <div class="col">
            <article class="article_items">
                <a href="#">
                <img src="img/pesca.png" alt="item" title="item" />
                </a>
            <p>Pesca</p>
        </div>
        <div class="col">
            <article class="article_items">
                <a href="#">
                <img src="img/mergulho.png" alt="item" title="item" />
                </a>
            <p>Mergulho</p></div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <article class="article_items">
                <a href="#">
                <img src="img/guardasol.png" alt="item" title="item" />
                </a>
            <p>guarda sol</p>
        </div>
        <div class="col">
            <article class="article_items">
                <a href="#">
                <img src="img/mala.png" alt="item" title="item" />
                </a>
            <p>Mala</p></div>
    </div>
</div>
