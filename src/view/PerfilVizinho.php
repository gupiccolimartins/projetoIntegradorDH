                ...
                <section class="div_feed_items col-md-10">
                        ...
                        <div class="col">
                            <article class="article_items">
                                <a href="#" class="card-link" data-toggle="modal" data-target="#modaldetalhe">
                                    <img src="img/itens/furadeiraView.png" alt="item" title="item" />
                                </a>
                                <p>Furadeira</p>
                        </div>
                        <div class="col">
                            <article class="article_items">
                                <a href="#" class="card-link" data-toggle="modal" data-target="#modaldetalhe">
                                    <img src="img/itens/muffinView.png" alt="item" title="item" />
                                </a>
                                <p>Muffin</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <article class="article_items">
                                <a href="#" class="card-link" data-toggle="modal" data-target="#modaldetalhe">
                                    <img src="img/itens/pescaView.png" alt="item" title="item" />
                                </a>
                                <p>Pesca</p>
                        </div>
                        <div class="col">
                            <article class="article_items">
                                <a href="#" class="card-link" data-toggle="modal" data-target="#modaldetalhe">
                                    <img src="img/itens/mergulhoView.png" alt="item" title="item" />
                                </a>
                                <p>Mergulho</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <article class="article_items">
                                <a href="#" class="card-link" data-toggle="modal" data-target="#modaldetalhe">
                                    <img src="img/itens/guardasolView.png" alt="item" title="item" />
                                </a>
                                <p>guarda sol</p>
                        </div>
                        <div class="col">
                            <article class="article_items">
                                <a href="#" class="card-link" data-toggle="modal" data-target="#modaldetalhe">
                                    <img src="img/itens/malaView.png" alt="item" title="item" />
                                </a>
                                <p>Mala</p>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-toggle="modal"
                                        data-dismiss="modal" data-target="#modalInteresse">Eu Quero</button>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                        data-toggle="modal" data-target="#modalSucesso">Enviar</button>
                                </div>
                            </div>
