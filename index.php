...
<body>
    ...
    <div class="fundoTexto">
            ...
            <br>Deixa com a gente! Aqui você vai encontrar o que precisa com as pessoas certas para emprestar! 
    ...
    <div class="fundoCards">
            ...
            <div class="cards">
                ...
                <div class="row">
                    ...
                    <div class="depoimento">
                        “Depois que começamos usar o Vizinholine, nosso condominio ficou mais unido, as pessoas ficaram mais gentis!”                    </div>   
                </div>
            </div>
            ...
            <div class="cards">
                ...
                <div class="row">
                    ...
                    <div class="depoimento">
                        “Nunca mais comparei coisas que sei que usarei poucas vezes! E não tenho problema em emprestar coisas que possuo!”                </div>    
                </div>
            </div>       
    </div>
    <div class="row">
                    ...
                    <form>
                        <div class="form-group">
                            <div class=col-10>
                                ...
                                <input type="text" class=" form-control form-control-lg" name="usuario" id="usuario" value="">
                            </div>        
                        </div>    
                        <div class="form-group">
                            <div class=col-10>
                                    <label for="senha">Senha</label>
                                    <input type="password" class="form-control form-control-lg" name="senha" id="senha" value="">
                            </div>
                        </div>   
                        <div class="row">
                            <div class="col-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                            <button type="button" class="btn btn-link" data-dismiss="modal" data-toggle="modal" data-target="#recuperar-senha">Esqueceu sua senha?</button>
                            </div>
                        </div>
                    ...
                    <form>
                        <div class="form-group">
                            <div class=col-10>
                                ...
                                <input type="email" class=" form-control form-control-lg" name="email" id="email" value="">
                            </div>        
                        </div>    
